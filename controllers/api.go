...
var (
	AUDIT_STATUS = [5]string{"<span class='layui-badge layui-bg-black'>fora de serviço</span>",
		"<span class='layui-badge layui-bg-orange'>Em desenvolvimento</span>",
		"<span class='layui-badge layui-bg-blue'>Em revisão</span>",
		"<span class='layui-badge layui-bg-green'>Aprovado</span>",
		"<span class='layui-badge'>Reprovado</span>"}
	AUDIT_STATUS_TEXT = [5]string{"fora de serviço",
		"Em desenvolvimento",
		"Em revisão",
		"Aprovado",
		"Reprovado"}
	REQUEST_METHOD = [6]string{"N RTEG", "GET", "POST", "PUT", "PATCH", "DELETE"}
)
