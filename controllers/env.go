...
func (self *EnvController) List() {
	self.Data["pageTitle"] = "Configurações de ambiente"
	self.display()
}

func (self *EnvController) Add() {
	self.Data["pageTitle"] = "Novo Ambiente"
	self.display()
}

func (self *EnvController) Edit() {
	self.Data["pageTitle"] = "Alterar Ambiente"
...
func (self *EnvController) AjaxSave() {
	...
	if Env_id == 0 {
		...
		if err == nil {
			self.ajaxMsg("O nome já existe", MSG_ERR)
		}
