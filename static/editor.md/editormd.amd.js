...
;(function(factory) {
    ...
    editormd.defaults     = {
        ...
        lang : {
            name        : "zh-cn",
            description : "开源在线MarkdownEditar器<br/>Open source online Markdown editor.",
            tocTitle    : "目录",
            toolbar     : {
                ...
                pagebreak        : "插入分页符",
                "goto-line"      : "跳转到行",
                watch            : "Fechar visualização ao vivo",
                unwatch          : "开启实时预览",
    ...
    editormd.prototype    = editormd.fn = {
         ...
         * 
         * @param   {Boolean}   recreate   是否为重建Editar器
         * @returns {editormd}             返回editormd的实例对象
         */
         ...
         * Set editor width
         * 
         * @param   {Number|String} width  Editar器宽度值
         * @returns {editormd}             返回editormd的实例对象
         */
         ...
         * Set editor height
         * 
         * @param   {Number|String} height  Editar器高度值
         * @returns {editormd}              返回editormd的实例对象
         */
         ...
         * 
         * @param   {Number|String} [width=null]  Editar器宽度值
         * @param   {Number|String} [height=null] Editar器高度值
         * @returns {editormd}                    返回editormd的实例对象
         */
        ...
        save : function() {
            ...
            var markedOptions = this.markedOptions = {
                ...
                breaks      : true,
                pedantic    : false,
                sanitize    : (settings.htmlDecode) ? false : true,  // Fechar忽略HTML标签，即开启识别HTML标签，默认为false
                smartLists  : true,
                smartypants : true
            };
