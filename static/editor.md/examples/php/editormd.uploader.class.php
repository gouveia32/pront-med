    ...
    */
    ...
    class EditorMdUploader
    {
        ...
        private function moveFile()
        {
            ...
            @unlink($files["tmp_name"]); //Excluir临时文件
         ...
         *
         * @access  private
         * @return  string         $fileName      Retorna a string de nome de arquivo gerada
         */

        private function randomFileName()
        {
            if ($this->randomNameType == 1)        // Gerar nome de arquivo de formato de hora
            {
                date_default_timezone_set('GMT-3');  //definir fuso horário
                
                $date     = date($this->randomLength);
                $fileName = $date . "_" . mt_rand(10000, 99999);
            }
            elseif ($this->randomNameType == 2)    // Gerar nomes de arquivos de caracteres aleatórios
            {
