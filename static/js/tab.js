        ...
        var r = {
            ...
            createTabDom: function() {
                ...
                if (i._parentElem = e.elem, !i.tabDomExists()) {
                    var a = ['<div class="layui-tab layui-tab-card kit-tab" lay-filter="' + i._filter + '">', '<ul class="layui-tab-title">', '<li class="layui-this" lay-id="-1"><i class="layui-icon">&#xe68e;</i> Sistema</li>', "</ul>", '<div class="kit-tab-tool kit-tab-bg"><i class="fa fa-ellipsis-v"></i></div>', '<div class="kit-tab-tool-body layui-anim layui-anim-upbit">', "<ul>",  '<li class="kit-item" data-target="closeCurrent">Fechar Aba Atual</li>', '<li class="kit-item" data-target="closeOther">Fechar as Outras Abas</li>', '<li class="kit-line"></li>', '<li class="kit-item" data-target="closeAll">Fechar todas as guias</li>', "</ul>", "</div>", '<div class="layui-tab-content">', '<div class="layui-tab-item layui-show" lay-item-id="-1"><iframe src="' + e.mainUrl + '"></iframe></div>', "</div>", "</div>"];
