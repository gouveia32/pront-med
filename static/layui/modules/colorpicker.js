    ...
    ,elemPicker = that.elemPicker = $(['<div id="layui-colorpicker'+ that.index +'" data-index="'+ that.index +'" class="layui-anim layui-anim-upbit layui-colorpicker-main">'
      ...
      ,'<div class="layui-colorpicker-main-input">'
        ...
        ,'<div class="layui-btn-container">'
          ,'<button class="layui-btn layui-btn-primary layui-btn-sm" colorpicker-events="clear">vazio</button>'
          ,'<button class="layui-btn layui-btn-sm" colorpicker-events="confirm">Sim</button>'
        ,'</div'
      ,'</div>'
    ,'</div>'].join(''))
