    ...
    if(options.url){ //Ajax请求
      ...
      $.ajax({
        ...
        ,success: function(res){
          ...
          if(res[response.statusName] != response.statusCode){
            ...
            that.errorView(
              ...
              ('Os dados retornados não estão de acordo com a especificação, o código de status de sucesso correto deve ser: "'+ response.statusName +'": '+ response.statusCode)
            );
          } else {
        ...
        ,error: function(e, msg){
          that.errorView('Falha ao tentar ler os dados, mensagem de erro:'+ msg);
